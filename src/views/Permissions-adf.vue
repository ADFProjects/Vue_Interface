        ...
        <v-container class="my-application">
          ...
          <v-card>
            ...
            >
              ...
              <v-container v-show="!permissionsToggle" class="my-application">
                <v-card>
                  <v-card-title
                    class="grey--text text--darken-2 my-application"
                  >
              ...
              <v-container v-show="empToggle">
                <v-card>
                  ...
                  <v-tooltip bottom>
                    ...
                    <span class="my-application"> البحث بإسم الموظف</span>
                  </v-tooltip>
                  <v-data-table
                    style="color: #595959; font-weight: bold !important"
                    :search="search"
                    class="my-application"
                    :headers="headers"
                    :items="employeesList"
                  ...
                  >
                    ...
                    <template v-slot:no-data>
                      <v-alert
                        ...
                        "
                      >
                        <span class="my-application"> لايوجد بيانات </span>
                      </v-alert>
                    </template>
                    <v-alert
                      id="tdAll"
