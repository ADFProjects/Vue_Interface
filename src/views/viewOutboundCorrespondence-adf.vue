                ...
                <v-row>
                  <v-col>
                    <v-text-field
                      ...
                      required
                      outlined
                      ref="selectedCorrespondenceType"
                    ></v-text-field>
                  </v-col>
                  <v-col>
                    <v-text-field
  ...
  methods: {
    resend() {
      var obj = {
        ...
        selectedConfid: this.selectedConfid,
        selectedCorrespondenceType: this.selectedCorrespondenceType,
        selectedObjectiveClass: this.selectedObjectiveClass,
        toCopies: this.toCopies,
        title: this.title,
    ...
    deleteCorrespondence() {
      ...
      Vue.axios
        ...
        .then((resp) => {
          this.showAlterSuccessMessage( "تم الغاء المعاملة بنجاح" ,"تم الالغاء ");
          this.$router.push({
            name: "internalOutboundbox", //use name for router push
          });
...
<html>
  ...
  <body>
    ...
    sendRequest() {
      ...
      Vue.axios
        ...
        .then((resp) => {
          ...
          console.log(resp.data);
          this.showAlterSuccessMessage(  "تم تسجيل طلب إرسال أصل بنجاح" ,"تم التسجيل ");
          this.$router.push({
    ...
    send() {
      this.sendRequestBody.RequestTypeID= 8;
      this.sendRequestBody.IncidentNumber = "";
      console.log(JSON.stringify(this.sendRequestBody));
      this.isLoading = true;
      Vue.axios
        .post(
    ...
    showAlterSuccessMessage(title , msg) {
      this.$fire({
        title: title,
        text: msg,
        type: "success",
