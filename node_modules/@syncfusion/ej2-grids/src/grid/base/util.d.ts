...
/** @hidden */
export declare function getCurrentTableIndex(gObj: IGrid): number;
/** @hidden */
export declare function getFrozenTableName(gObj: IGrid, index?: number): freezeTable;
/** @hidden */
export declare function getFreezeTableName(gObj: IGrid, index?: number): freezeTable;
/** @hidden */
export declare function getColumnLevelFreezeTableName(gObj: IGrid, index?: number): freezeTable;
/** @hidden */
...
/** @hidden */
export declare function setValidationRuels(col: Column, index: number, rules: Object, mRules: Object, frRules: Object, len: number): void;
/** @hidden */
...
/** @hidden */
export declare function getNumberFormat(numberFormat: string, type: string): string;
